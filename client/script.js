...
function generateString() {
  var str = btoa(JSON.stringify(movedPlayers));

  document.getElementById("generated-string").setAttribute("value", str);
}

// configure board using string given from admins
function setString() {
  var temp = document.getElementById("input-string").value;
  if(temp == "") {
  ...
  players = temp;
  movedPlayers = JSON.parse(JSON.stringify(temp));
